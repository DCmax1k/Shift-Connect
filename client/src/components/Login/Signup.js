    ...
    render() {
        return (
            <div className="Signup Login">
                ...
                <Input onInput={this.changeUsername} className="indexLogin" placeholder={"Full name"} type="text" />
                ...
                <div onClick={this.submitData} className='btn' style={{backgroundColor: "#5781C0", color: "#FFFFFF"}}>{this.state.signupBtnText}</div>
